...
export { default as PancakeRoundGreenIcon } from "./Icons/PancakeRoundGreen";
export { default as RemoveIcon } from "./Icons/Remove";
export { default as VerifiedIcon } from "./Icons/Verified";
export { default as VerifyInfoIcon } from "./Icons/VerifyInfo";
...
export { default as SyncVerticalIcon } from "./Icons/SyncVert";
